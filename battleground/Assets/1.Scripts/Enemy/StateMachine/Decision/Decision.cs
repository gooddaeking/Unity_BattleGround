...
public abstract class Decision : ScriptableObject
{
    ...
    public delegate bool HandleTargets(StateController controller, bool hasTargets, Collider[] targetRadius);
    public static bool CheckTargetInRadius(StateController controller, float radius, HandleTargets handleTargets)
    {
        ...
        {
            Collider[] targetsInRadius = Physics.OverlapSphere(controller.transform.position, radius,
